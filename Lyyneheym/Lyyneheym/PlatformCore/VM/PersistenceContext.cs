...
namespace Yuri.PlatformCore.VM
{
    ...
    internal static class PersistenceContext
    {
        ...
        public static bool Remove(string varName) {return PersistenceContext.symbols.Remove(varName);}
        ...
        public static bool Exist(string varName) { return PersistenceContext.symbols.ContainsKey(varName); }
