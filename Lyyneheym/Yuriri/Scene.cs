...
namespace Yuri.Yuriri
{
    ...
    public sealed class Scene
    {
        ...
        public string GetILSign() {return String.Format(">>>YuriIL?{0}", this.Scenario);}
        ...
        public SceneAction RetrieveAction(string actName) {return this.YuriDict.ContainsKey(actName) ? this.YuriDict[actName] : null;}
        ...
        /// <returns>IL文件头字符串</returns>
        public static string GetILSign(Scene scene) {return String.Format(">>>YuriIL?{0}", scene.Scenario);}
